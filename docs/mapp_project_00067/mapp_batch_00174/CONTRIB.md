...
```bash
sg commons-users -c './copy_files.sh -i /media/share/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00067/mapp_batch_00174 -p "*202505131015_CVOL_*.mzML"'
```
...
cp ./metadata/treated/mapp_batch_00174_metadata.tsv /msdata/mapp_project_00067/mapp_batch_00174/
```
...
```bash
cd ./docs/mapp_project_00067/mapp_batch_00174/results/mzmine
```

And proceed to awk black magic to update the mzmine xml file

```bash
awk -v dir="/msdata/mapp_project_00067/mapp_batch_00174" '
BEGIN {
  cmd = "ls " dir "/*.mzML"
...
}' mapp_batch_00174.mzbatch_template > mapp_batch_00174.mzbatch
```
...
```bash
sg commons-users -c '/opt/mzmine/bin/mzmine -batch mapp_batch_00174.mzbatch'
```
...
```bash
taxonomical-utils append-taxonomy --input-file docs/mapp_project_00067/mapp_batch_00174/metadata/original/mapp_batch_00174_metadata_resolved.csv --output-file docs/mapp_project_00067/mapp_batch_00174/metadata/original/metadata_upper_taxa_lineage.csv
```

3. append WD ids 

```bash
taxonomical-utils append-wd-id --input-file docs/mapp_project_00067/mapp_batch_00174/metadata/original/mapp_batch_00174_metadata_resolved.csv --output-file docs/mapp_project_00067/mapp_batch_00174/metadata/original/mapp_batch_00174_wd.csv
```
...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/mapp-metabolomics-unit/jbuf-trees/docs/mapp_project_00067/mapp_batch_00174/results
```
...
paths:
  gnps_job_id: 4e5060d5d8204d90b5c44867b808e9d1 # The GNPS job id you want to treat
...
```bash
cd ./docs/mapp_project_00067/mapp_batch_00174
find ./results/met_annot_enhancer/4e5060d5d8204d90b5c44867b808e9d1 -type l -exec rm {} +
```
...
gnps_job_id : 4e5060d5d8204d90b5c44867b808e9d1

dataset_experiment : 
  name: "mapp_batch_00174 LCMS metabolomics dataset"
  description: "Untargeted metabolomics of trees from the JBUF - pos"
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_structure_summary.tsv --gnps-file ./results/met_annot_enhancer/4e5060d5d8204d90b5c44867b808e9d1/nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer/4e5060d5d8204d90b5c44867b808e9d1/nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/structure_identifications.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00174/mapp_batch_00174_spectral_match_results_repond_flat.tsv --output ./results/tmp/mapp_batch_00174_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer/4e5060d5d8204d90b5c44867b808e9d1/nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00174/mapp_batch_00174_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/structure_identifications.tsv  --output ./results/tmp/mapp_batch_00174_met_annot_unified_vertical.tsv
```